...
class Program
{
    static void Main()
    {
        ...
        string chipherTextPath = "C:\\work prog\\інформаційна безпека\\C#\\Main\\7.2\\encrypteddata.txt"; 
        string friendPublicKeyPath = "C:\\work prog\\інформаційна безпека\\C#\\Main\\7.2\\Bessarab_RSAPublicKey.xml"; 
